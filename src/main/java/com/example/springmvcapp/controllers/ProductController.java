...
import com.example.springmvcapp.repositories.ProductRepository;
...
public class ProductController {
    ...
    public String save(@RequestParam String prodName, @RequestParam String prodDesc, @RequestParam Double prodPrice, @RequestParam String prodImage) {
        ...
        //return "redirect:/show/" + product.getId(); // Przechodzi do widoku zapisanego produktu
        return "redirect:/product"; // Przechodzi do listy
    }
